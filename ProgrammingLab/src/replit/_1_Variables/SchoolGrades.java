...
public class SchoolGrades {
    public static void main(String[] args) {
        ...
        double avarageScore= (score1+score2+score3+score4+score5)/5;

        System.out.println("Summary: "+subject1+" - "+score1+", "+subject2+" - "                  +score2+", "+subject3+" - "+score3+", "+subject4+" - "+score4+", "
                +subject5+" - "+score5);

        System.out.println("Your average score is: "+avarageScore+
...
// to hold the subject and the grade value. Build a summary with all the information by concatenating
// the subjects and grades. Then calculate the average grade and print display the average score too.
//
